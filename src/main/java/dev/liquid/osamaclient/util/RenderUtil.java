...
public class RenderUtil {
  ...
  public static void drawPoint(Vec3 point, Color color, int pointSize){
    double radius = pointSize/200.0;
    double x = point.xCoord - radius;
    double y = point.yCoord - radius;
    double z = point.zCoord - radius;
    double x2 = point.xCoord + radius;
    double y2 = point.yCoord + radius;
    double z2 = point.zCoord + radius;
